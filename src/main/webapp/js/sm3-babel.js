...
function sm3digest(str, format) {
  var binary = (format == 'hex') ? hex2binary(str) : str2binary(str);
  // 填充
...
function sm3(str, userid, pk) {
  if (userid && pk) {
    var z = sm3digest('0080' + binary2hex(str2binary(userid)) + '' + pk, 'hex');
    return sm3digest(z + binary2hex(str2binary(str)), 'hex');
  } else return sm3digest(str, 'str');
}
